...
Example usage:
  kb_obj_export --id my-dashboard-id --type dashboard
  kb_obj_export --id my-dashboard-id --type dashboard --include-dependencies
  kb_obj_export --id my-dashboard-id --type dashboard --output-dir /path/to/exports --filename custom-name`,
		Example: `kb_obj_export --id my-dashboard-id --type dashboard
kb_obj_export --id my-dashboard-id --type dashboard --include-dependencies
kb_obj_export --id my-dashboard-id --type dashboard --output-dir ./exports --filename my-export`,
